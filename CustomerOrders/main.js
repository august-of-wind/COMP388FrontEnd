  ...
  function getOrders(){
    ...
    $.ajax({
      ...
      var i;
      var table="<table class='table'><tr><th>ID</th><th>Product Name</th><th>Seller Name</th><th>Order Status</th><th>Cancel?</th><th>Review Product</th><th>Review Seller</th>";
      ...
      for (i = 0; i <x.length; i++) {
        ...
        + "</td><td>" + cancelButton + "</td><td>" + reviewProdButton + '</td><td>' + reviewSellerButton + '</td></tr>' 
      }
